...
Shader "Ocean"
{
	Properties
	{
		...
		[ASEBegin]_Waves("Waves", Float) = 0
		_Espuma("Espuma", Color) = (0.9292453,1,0.9946488,0)
		[ASEEnd]_Color("Color", Color) = (0.3523051,0.8207547,0.7845023,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult12 = (float4(WorldPosition.x , WorldPosition.z , 0.0 , 0.0));
				float2 panner13 = ( 1.0 * _Time.y * float2( 1,1 ) + appendResult12.xy);
				float2 coords14 = panner13 * _Waves;
				float2 id14 = 0;
				float2 uv14 = 0;
				float voroi14 = voronoi14( coords14, time14, id14, uv14, 0, voronoiSmoothId14 );
				float4 lerpResult19 = lerp( _Espuma , _Color , ( 1.0 - voroi14 ));
...
/*ASEBEGIN
Version=18935
494;73;596;364;1099.361;428.3797;1.84;False;False
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-1240.925,-126.215;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.OneMinusNode;18;-489.8351,-69.94495;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;19;-239.6201,-199.5399;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;17;-547.1356,-458.05;Inherit;False;Property;_Espuma;Espuma;1;0;Create;True;0;0;0;False;0;False;0.9292453,1,0.9946488,0;0.9292453,1,0.9946488,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;14;-686.78,-117.94;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.PannerNode;13;-896.2504,-103.045;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-873.7955,40.94001;Inherit;False;Property;_Waves;Waves;0;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;12;-1045.635,-103.045;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;16;-552.7253,-286.7499;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;0.3523051,0.8207547,0.7845023,0;0.2745098,0.5347979,0.6039216,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A3B79D3BC32DD494141B765FE4F0E98552F83762